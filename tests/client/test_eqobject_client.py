...
from easyqueue.client.eqobject_client import EQObjectClient
...
class TestEQObjectClient(unittest.TestCase):
    ...
    def test_init(self):
        ...
        client = EQObjectClient(host=host, port=port, protocol=protocol, verify=verify, timeout=timeout, proxies=proxies)
    ...
    def test_is_correct_status_code_ok_200(self):
        ...
        client = EQObjectClient(host='host')
