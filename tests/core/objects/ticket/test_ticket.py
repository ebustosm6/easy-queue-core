...
class TestTicket(unittest.TestCase):
    ...
    def test_init_ok(self):
        ...
        is_active = True
        expected_id = '51202263706134248a8e187ee9674c10'
        expected_identificator = 'ticket_region_FFFFFFF_user_identificator_queue_identificator'
        ...
        res = Ticket(
            user_id=user_id, user_identificator=user_identificator, region=region, h3=h3,
    ...
    def test_init_ko(self):
        expected_msg = {
            ...
            'identificator': ['Invalid double punctuation character "_"'],
        ...
        with self.assertRaises(Exception) as exp:
            Ticket(user_id='', user_identificator='', region='', h3='', queue_id='', queue_identificator='')
    ...
    def test_json_ok(self):
        ...
        is_active = True
        expected_res = {
            '_id': '51202263706134248a8e187ee9674c10',
            'identificator': 'ticket_region_FFFFFFF_user_identificator_queue_identificator',
    ...
    def test_validate_ok(self):
        res = Ticket(
            user_id='user_id', user_identificator='user_identificator', h3='FFFFFFF',
